...
# =======================
# Intent Keywords (copied from main.py)
# =======================
INTENT_KEYWORDS = {
    "Help_Request": ["help", "assist", "support", "emergency", "need help", "can you help", "stuck", "problem"],
    "Question": ["what", "why", "how", "when", "where", "who", "which", "whose", "whom", "can you tell", "do you know"],
    "Command": ["turn", "open", "close", "start", "stop", "call", "play", "pause", "resume", "set", "change", "switch", "activate", "deactivate"],
    "Greeting": ["hello", "hi", "hey", "good morning", "good afternoon", "good evening", "good night", "howdy", "greetings"],
    "Gratitude": ["thank you", "thanks", "appreciate", "grateful", "thank", "cheers"],
    "Farewell": ["goodbye", "bye", "see you", "later", "farewell", "good night", "take care", "catch you later"],
    "Confirmation": ["yes", "yeah", "yep", "sure", "okay", "alright", "correct", "right", "affirmative", "absolutely"],
    "Denial": ["no", "nope", "nah", "not really", "negative", "never", "don't think so"],
    "Complaint": ["hate", "annoying", "frustrated", "angry", "upset", "terrible", "awful", "worst", "bad"],
    "Praise": ["love", "great", "awesome", "excellent", "fantastic", "wonderful", "amazing", "perfect", "brilliant"],
    "Request_Info": ["tell me", "show me", "explain", "describe", "inform", "let me know", "give me"],
    "Weather_Query": ["weather", "temperature", "forecast", "rain", "sunny", "cold", "hot", "climate"],
    "Time_Query": ["time", "date", "day", "hour", "minute", "clock", "calendar"],
    "Reminder": ["remind", "reminder", "don't forget", "remember", "schedule", "alert"],
    "Music_Request": ["play music", "song", "music", "playlist", "tune", "audio"],
    "Search_Request": ["search", "find", "look for", "look up", "google", "browse"],
}


# =======================
# Audio Responses (copied from main.py)
# =======================
AUDIO_RESPONSES = {
    # Intent-based (highest priority)
    "Help_Request": "I am here to help you. Please tell me what you need.",
    "Question": "I understand your question. Let me assist you.",
    "Greeting": "Hello. How can I assist you today?",
    "Gratitude": "You are welcome. Happy to help.",
    "Farewell": "Goodbye. Have a great day ahead.",
    "Confirmation": "Understood. I will proceed with that.",
    "Denial": "Okay, I understand. Let me know if you change your mind.",
    "Complaint": "I understand your frustration. Let me see how I can help improve this.",
    "Praise": "Thank you so much. I appreciate your kind words.",
    "Request_Info": "Of course. Let me provide that information for you.",
    "Weather_Query": "Let me check the weather information for you.",
    "Time_Query": "Let me get that time information for you.",
    "Reminder": "I will set up that reminder for you right away.",
    "Music_Request": "Playing your music request now.",
    "Search_Request": "Searching for that information now.",
    "Command": "Executing your command.",
    # Sentiment-based (fallback only)
    "Positive": "I am glad to hear that.",
    "Negative": "I am sorry to hear that. Do you need some help?",
    # Neutral fallback
...
def select_audio_response(intent, sentiment):
    # 1. Intent has highest priority
    if intent in ["Help_Request", "Question", "Greeting", "Gratitude"]:
        return AUDIO_RESPONSES[intent]

    # 2. Use sentiment ONLY for generic statements
    if sentiment in ["Positive", "Negative"]:
        return AUDIO_RESPONSES[sentiment]

    # 3. Final fallback
    return AUDIO_RESPONSES["Neutral"]
